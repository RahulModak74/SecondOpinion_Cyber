"""
Enhanced SecondOpinion with INSTRUCTOR embeddings and dual vector stores
...
class EnhancedSecondOpinionAnalyzer:
    def __init__(self, 
        ...
        """
        Initialize the SecondOpinion analyzer with dual FAISS stores and INSTRUCTOR embedding model
        ...
        print(f"Loading INSTRUCTOR embedding model: {model_name}")
    ...
    def load_incidents_index(self):
        ...
        # Load instruction for incidents
        try:
    ...
    def query_similar_incidents(self, query_text: str, k: int = 5) -> List[Dict[str, Any]]:
        ...
        # Generate embedding for query using INSTRUCTOR
        query_embedding = self.model.encode([[self.incidents_instruction, query_text]], convert_to_numpy=True)
    ...
    def query_similar_chains(self, query_text: str, k: int = 5) -> List[Dict[str, Any]]:
        ...
        # Generate embedding for query using INSTRUCTOR
        query_embedding = self.model.encode([[self.chains_instruction, query_text]], convert_to_numpy=True)
